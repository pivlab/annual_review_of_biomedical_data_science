...
Machine learning methods can compress correlations into lower-dimensional representations, facilitating the processing of large datasets to identify intricate co-expression patterns.
...
Nandi et al.
(2024) demonstrated its utility in the Human Trisome Project (HTP) [@url:https://www.trisome.org], identifying gene modules that mediate the effect of karyotype on body mass index in Down syndrome and highlighting key regulators such as *GPX1* and *MCL1*.
