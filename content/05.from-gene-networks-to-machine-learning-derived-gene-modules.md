...
Nandi et al.
(2024) demonstrated its utility in the Human Trisome Project (HTP) [@url:https://www.trisome.org], identifying gene modules that mediate the effect of karyotype on body mass index in Down syndrome, highlighting key regulators such as *GPX1* and *MCL1*.
