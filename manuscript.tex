...
This manuscript
(\href{https://pivlab.github.io/annual_review_of_biomedical_data_science/v/876267bf5f5cb653b6898a4b032be3be7ca3b9f8/}{permalink})
was automatically generated
from \href{https://github.com/pivlab/annual_review_of_biomedical_data_science/tree/876267bf5f5cb653b6898a4b032be3be7ca3b9f8}{pivlab/annual\_review\_of\_biomedical\_data\_science@876267b}
on October 10, 2024.
...
Although there are several limitations when we only correlate gene pairs across RNA-seq samples {[}\protect\hyperlink{ref-jVQ2rMqc}{95}{]}, integrating gene networks with other data modalities have the potential to identify disease-relevant molecular mechanisms {[}\protect\hyperlink{ref-dg9nKuy0}{54}{]}.
...
\CSLLeftMargin{94. }%
\CSLRightInline{\textbf{A Pathway-Level Information Extractor (PLIER) Framework to Gain Mechanistic Insights into Obesity in Down Syndrome}
\CSLBlock{Sutanu Nandi, Yuehua Zhu, Lucas A Gillenwater, Marc Subirana Ganes, Haoyu Zhang, Negar Janani, Casey Greene, Milton Pividori, Maria Chikina, James C Costello} \emph{Proceedings of the Pacific Symposium on Biocomputing 2025 (PSB2025)} (2024)}
...
\CSLLeftMargin{102. }%
\CSLRightInline{\textbf{CuPy: A NumPy-Compatible Library for NVIDIA GPU Calculations}
\CSLBlock{Ryosuke Okuta, Yuya Unno, Daisuke Nishino, Shohei Hido, Crissman Loomis} \emph{Proceedings of Workshop on Machine Learning Systems (LearningSys) in The Thirty-first Annual Conference on Neural Information Processing Systems (NIPS)} (2017)}
