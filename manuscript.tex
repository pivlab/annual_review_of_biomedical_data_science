...
This manuscript
(\href{https://pivlab.github.io/annual_review_of_biomedical_data_science/v/c8700003a8eb14c6846aa02abead1551b794c2e1/}{permalink})
was automatically generated
from \href{https://github.com/pivlab/annual_review_of_biomedical_data_science/tree/c8700003a8eb14c6846aa02abead1551b794c2e1}{pivlab/annual\_review\_of\_biomedical\_data\_science@c870000}
on October 11, 2024.
...
Specifically, DL methods like autoencoders (\protect\hyperlink{ref-arxiv:1312.6114}{\textbf{arxiv:1312.6114?}}), which utilize neural networks to learn compressed representations, can capture both linear and nonlinear patterns between genes.
...
Approaches such as PLIER and PhenoPLIER have been fundamental to extract DS-specific gene modules related to obesity, a common co-occurring condition (\protect\hyperlink{ref-B7FF0NeZ}{94}).
...
Although there are several limitations when we only correlate gene pairs across RNA-seq samples (\protect\hyperlink{ref-jVQ2rMqc}{95}), integrating gene networks with other data modalities have the potential to identify disease-relevant molecular mechanisms (\protect\hyperlink{ref-dg9nKuy0}{55}).
...
Gene co-expression networks, represented as gene modules, have been successfully used across a variety of fields (\protect\hyperlink{ref-CqvNaEqc}{96}--\protect\hyperlink{ref-E1tpJnqG}{98}).
...
Additionally, metabolic networks influence enzyme activities and metabolite levels, propagating changes that affect numerous other molecules (\protect\hyperlink{ref-dg9nKuy0}{55}, \protect\hyperlink{ref-KNAOTAKP}{99}).
